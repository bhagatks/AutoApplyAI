import { c as createLucideIcon, j as jsxRuntimeExports, B as BrandLockup, a as BrandWordmark, r as reactExports, R as React, b as client } from "./BrandLockup-Dmic_fsE.js";
import { g as getParsedResumeBaseVersion, d as detectPlatformFromUrl, b as buildRulesForTailor, c as computeJobHashes, f as formatExperienceForPrompt, r as runPass1Generate, a as runPass2Optimize, s as substituteForbiddenWords, e as cleanLatex, h as syncJobFromTailoredResume, i as formatAiErrorToast, j as createAiHttpError, k as saveTailoredResume, l as saveJobToDb, L as LogOut, u as useToast, m as auth, o as onAuthStateChanged, U as User, S as Settings, P as Plus, n as jobListFitBadge, T as Trash2, p as Loader, q as Sparkles, J as JobFitPanel, C as Copy, D as Download, t as normalizeName, v as Printer, w as resolveEducationEntries, E as EyeOff, x as Eye, y as ToastStack, G as GoogleAuthProvider, z as signInWithPopup, A as clearAllLocalAppData, B as signOut, F as saveCustomerConfig, H as getAiErrorToastVariant, I as deleteJobFromDb, K as buildResumeLatex, M as buildCoverLetterLatex, N as isCustomerConfigComplete, O as prepareFirestoreAccess, Q as subscribeToJobs, R as getCustomerConfig, V as initSentry, W as ErrorBoundary } from "./errorboundary-CPEENljf.js";
...
function createIds(existingJobId, existingResumeId) {
...
function buildInitialJob(jobId, resumeId, jobDescription, jobUrl, initialJobTitle, initialCompanyName, platform) {
  return {
    id: jobId,
    resumeId,
...
function buildInitialResume(resumeId, jobId, baseVersion, job, provider, model) {
...
function normalizeTailoredExperience(raw, parsedResume) {
  if (!Array.isArray(raw)) return [];
  const exp = (parsedResume == null ? void 0 : parsedResume.experience) || [];
  return raw.map((item) => ({
...
async function persistJobAndResume(userId, job, resume) {
  if (!userId) return;
  const CLOUD_PERSIST_TIMEOUT_MS = 15e3;
  try {
    await Promise.race([
      (async () => {
      ...
      new Promise(
        (_, reject) => setTimeout(() => reject(new Error("Firestore sync timed out")), CLOUD_PERSIST_TIMEOUT_MS)
      )
    ]);
  } catch (err) {
...
async function notifyJobUpdate(onJobUpdate, job) {
  if (onJobUpdate) {
    await onJobUpdate(job);
  }
}
async function executeTailorJob(options) {
  const {
    userId,
    jobDescription,
    jobUrl,
  ...
  const platform = platformOverride || (jobUrl ? detectPlatformFromUrl(jobUrl) : void 0);
  ...
  const jdFetchedAt = (/* @__PURE__ */ new Date()).toISOString();
  ...
  try {
    ...
    const tailoredSkills = Array.isArray(pass2Result.tailoredSkills) ? pass2Result.tailoredSkills.map(String).filter(Boolean) : Array.isArray(pass2Result.skills) ? pass2Result.skills.map(String).filter(Boolean) : [];
    const now = (/* @__PURE__ */ new Date()).toISOString();
    resume = {
      ...resume,
    ...
    await persistJobAndResume(userId, job, resume);
    await notifyJobUpdate(onJobUpdate, job);
    throw createAiHttpError(message, (err == null ? void 0 : err.status) ?? 0, (err == null ? void 0 : err.body) ?? "");
  }
}
function ExtensionSetupPrompt({ onSignOut }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BrandLockup, { size: "lg", className: "brand-lockup--center", style: { marginBottom: 16, width: "100%" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: {
      ...
      marginBottom: 8
    }, children: "Finish setup in Chrome" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--text-secondary)", fontSize: "0.9rem", lineHeight: 1.55, marginBottom: 24 }, children: "First-time setup — resume upload, output folder, and API key — runs in the extension sidepanel where you apply to jobs." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { style: { marginBottom: 10 }, children: [
        "Click the ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(BrandWordmark, { as: "span", size: "sm" }),
        " icon in your Chrome toolbar."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { style: { marginBottom: 10 }, children: "Open the sidepanel (pin it for quick access)." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { style: { marginBottom: 10 }, children: [
        "Complete ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Get started" }),
        " — upload resume, API key, output folder."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Return here to review job history once setup is done." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "0.78rem", color: "var(--text-muted)", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PanelRight, { size: 14 }),
        " Setup is not available on the web dashboard by design."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "btn btn-primary", style: { textDecoration: "none", width: "100%", padding: 12 }, children: "Back to homepage" }),
      onSignOut && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "btn", onClick: () => onSignOut(), style: { width: "100%", padding: 12 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { size: 16 }),
        " Sign out"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { marginTop: 20, fontSize: "0.72rem", color: "var(--text-muted)", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chrome, { size: 12 }),
      " Don't have the extension yet? ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/#install", style: { color: "var(--brand)" }, children: "Install from the homepage" })
    ] })
  ] }) });
}
const DEFAULT_RULES = {
...
function App() {
  ...
  const [authLinkedType, setAuthLinkedType] = reactExports.useState(null);
    ...
    try {
      ...
      if (isExtensionFlow2 && extId2) {
        ...
        if (credential) {
          ...
          const redirectUri = `https://${extId2}.chromiumapp.org/?idToken=${encodeURIComponent(idToken || "")}&accessToken=${encodeURIComponent(accessToken || "")}`;
  ...
  const handleTailorJob = async () => {
    ...
    const syncLocalJob = async (job) => {
      setSelectedJob(job);
      if (currentUser) return;
      const savedHistory = localStorage.getItem("localHistory");
      const existing = savedHistory ? JSON.parse(savedHistory) : jobs;
      const hasJob = existing.some((j) => j.id === job.id);
      const updated = hasJob ? existing.map((j) => j.id === job.id ? job : j) : [job, ...existing];
      setJobs(updated);
      localStorage.setItem("localHistory", JSON.stringify(updated));
    };
    try {
      const { job: finalJob } = await executeTailorJob({
        userId: currentUser == null ? void 0 : currentUser.uid,
        jobDescription,
        jobUrl,
        apiKey,
        rules,
        profile: candidateProfile,
        parsedResume: customerConfig == null ? void 0 : customerConfig.parsedResume,
        provider: (customerConfig == null ? void 0 : customerConfig.aiProvider) || "gemini",
        model: customerConfig == null ? void 0 : customerConfig.aiModel,
  ...
  const handlePrint = () => {
    ...
    const skills = ((_b2 = (_a2 = customerConfig == null ? void 0 : customerConfig.parsedResume) == null ? void 0 : _a2.skills) == null ? void 0 : _b2.filter(Boolean)) || [];
    const experience = (((_c2 = customerConfig == null ? void 0 : customerConfig.parsedResume) == null ? void 0 : _c2.experience) || []).filter((job) => {
      var _a3, _b3;
      return ((_a3 = job.company) == null ? void 0 : _a3.trim()) || ((_b3 = job.jobTitle) == null ? void 0 : _b3.trim());
    }).slice(0, 3);
    const education = resolveEducationEntries(customerConfig == null ? void 0 : customerConfig.parsedResume).filter((e) => {
      var _a3, _b3;
      return ((_a3 = e.degree) == null ? void 0 : _a3.trim()) || ((_b3 = e.school) == null ? void 0 : _b3.trim());
    });
        ...
        if (typeof chrome !== "undefined" && chrome.runtime && chrome.runtime.sendMessage) {
          console.log("[DEBUG LOG] Syncing GOOGLE_AUTH_SUCCESS payload to extension:", {
            ...
            profile: {
              ...
              lastName: ((_b2 = customerConfig == null ? void 0 : customerConfig.candidateProfile) == null ? void 0 : _b2.lastName) || "",
              email: ((_c2 = customerConfig == null ? void 0 : customerConfig.candidateProfile) == null ? void 0 : _c2.email) || ""
            }
          });
          chrome.runtime.sendMessage(extId, {
            ...
            token: idToken,
            profile: {
              firstName: ((_d2 = customerConfig == null ? void 0 : customerConfig.candidateProfile) == null ? void 0 : _d2.firstName) || "",
  ...
  if (authLinkedType) {
    return withToasts(
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", height: "100vh", width: "100vw", justifyContent: "center", alignItems: "center", background: "var(--bg-color)", padding: 24, boxSizing: "border-box" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detail-card", style: { maxWidth: 450, width: "100%", padding: "40px 32px", textAlign: "center", display: "flex", flexDirection: "column", gap: 24, boxShadow: "var(--panel-glow)" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--text-secondary)", fontSize: "0.85rem", margin: 0, lineHeight: 1.4 }, children: authLinkedType === "credentials" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Your credentials have been successfully transferred and linked to the",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(BrandWordmark, { as: "span", size: "sm" }),
            " Chrome Extension! Inspect this page's developer console to check transmission details."
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Your configuration settings have been successfully synced and linked to the",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(BrandWordmark, { as: "span", size: "sm" }),
            " Chrome Extension! Inspect this page's developer console to check sync details."
          ] }) }),
  ...
  if (authLoading || configLoading) {
    return withToasts(
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100vh", width: "100vw", justifyContent: "center", alignItems: "center", background: "var(--bg-color)", color: "var(--text-primary)" }, children: [
  ...
  if (!currentUser) {
      ...
      return withToasts(
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", height: "100vh", width: "100vw", justifyContent: "center", alignItems: "center", background: "var(--bg-color)", padding: 24, boxSizing: "border-box" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detail-card", style: { maxWidth: 450, width: "100%", padding: "40px 32px", textAlign: "center", display: "flex", flexDirection: "column", gap: 24, boxShadow: "var(--panel-glow)" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontFamily: "var(--font-title)", fontSize: "1.8rem", fontWeight: 800, color: "var(--brand)" }, children: "Link Extension" }),
    ...
    return withToasts(
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", height: "100vh", width: "100vw", justifyContent: "center", alignItems: "center", background: "var(--bg-color)", padding: 24, boxSizing: "border-box" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detail-card", style: { maxWidth: 400, width: "100%", padding: "40px 32px", textAlign: "center", display: "flex", flexDirection: "column", gap: 24, boxShadow: "var(--panel-glow)" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BrandLockup, { size: "lg" }),
  ...
  if (!isConfigComplete(customerConfig)) {
    return withToasts(/* @__PURE__ */ jsxRuntimeExports.jsx(ExtensionSetupPrompt, { onSignOut: handleSignOut }));
  }
  if (isExtensionFlow && extId) {
    return withToasts(
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", height: "100vh", width: "100vw", justifyContent: "center", alignItems: "center", background: "var(--bg-color)", padding: 24, boxSizing: "border-box" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "detail-card", style: { maxWidth: 450, width: "100%", padding: "40px 32px", textAlign: "center", display: "flex", flexDirection: "column", gap: 24, boxShadow: "var(--panel-glow)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BrandLockup, { size: "lg" }),
  ...
  return withToasts(
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-app", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "app-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-area", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrandLockup, { size: "md", subText: "Serverless Web Dashboard" }) }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "history-item-header", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "score-badge", children: jobListFitBadge(job) || `${job.atsScore}%` })
                ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pane-content", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-group", style: { background: "rgba(255, 128, 0, 0.05)", padding: 12, borderRadius: 8, border: "1px dashed rgba(255, 128, 0, 0.2)", marginBottom: 10 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, fontSize: "0.78rem", color: "var(--text-secondary)" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                ...
                " Install the ",
                /* @__PURE__ */ jsxRuntimeExports.jsx(BrandWordmark, { as: "span", size: "sm" }),
                " Extension to extract and tailor jobs from LinkedIn/Indeed in 1-click!"
              ] })
            ] }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "details-pane", children: selectedJob ? selectedJob.status === "processing" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%", justifyContent: "center", alignItems: "center", padding: 24, textAlign: "center", background: "var(--bg-color)" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "details-content", children: [
            ...
            activeTab === "cover" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "detail-card", style: { background: "var(--panel-bg-2)", border: "1px solid var(--panel-border)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "plain-text", style: { fontFamily: "Georgia, serif", fontSize: "0.95rem", color: "#e2e8f0" }, children: selectedJob.coverLetter }) })
            ] }),
            activeTab === "preview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "resume-preview-container", children: [
                ...
                ((_b = (_a = customerConfig == null ? void 0 : customerConfig.parsedResume) == null ? void 0 : _a.skills) == null ? void 0 : _b.length) ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                (((_c = customerConfig == null ? void 0 : customerConfig.parsedResume) == null ? void 0 : _c.experience) || []).filter((job) => {
                  var _a2, _b2;
                  return ((_a2 = job.company) == null ? void 0 : _a2.trim()) || ((_b2 = job.jobTitle) == null ? void 0 : _b2.trim());
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "resume-preview-bullets", children: resolveEducationEntries(customerConfig == null ? void 0 : customerConfig.parsedResume).filter((e) => {
                  var _a2, _b2;
                  return ((_a2 = e.degree) == null ? void 0 : _a2.trim()) || ((_b2 = e.school) == null ? void 0 : _b2.trim());
          ...
          settingsTab === "competencies" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "12px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { fontSize: "0.8rem", fontWeight: 700, color: "var(--text-secondary)", textTransform: "uppercase" }, children: [
                "Base Competencies (",
                ((_d = draftProfile.competencies) == null ? void 0 : _d.length) || 0,
                ")"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Something went wrong. Reload the page." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
//# sourceMappingURL=dashboard-BYcHf9mz.js.map

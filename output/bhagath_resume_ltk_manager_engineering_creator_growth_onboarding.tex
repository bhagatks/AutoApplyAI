...
{
\small \centering
\begin{center}\textbf{Visionary Engineering Leader | Creator Growth and Onboarding | Enterprise AI Integration}\end{center}\vspace{2mm}Engineering Leader with 20+ years of software development experience, specializing in building and scaling high-performing fullstack teams (iOS, Web, Backend) to drive creator growth and user onboarding across dynamic platforms. Proven track record in executing strategic technical roadmaps, owning agile delivery processes, and deploying highly scalable distributed systems for user-facing, high-visibility features within Dockerized CI/CD environments. Expert in fostering a culture of experimentation using A/B testing and data analytics, while driving the integration and optimization of enterprise AI tooling and influencing technical vision across XFN teams. Adept at cultivating talent, leading continuous rapid releases, and leveraging AWS services for cloud-native solutions.
\par}
...
\begin{itemize}
\item \textbf{Engineering Leadership  and  Talent Development:} Provides technical and people leadership, consistently leading, hiring, coaching, and managing the performance of diverse engineering teams, fostering growth, retention, and influencing XFN product and design relationships.\item \textbf{Agile Delivery  and  Product Ownership:} Owns the delivery process and Agile ceremonies, ensuring rapid, continuous releases, proper backlog refinement, and strategic work prioritization to reduce technical debt in CI/CD environments.\item \textbf{Fullstack Team Management  and  Architecture:} Experienced managing fullstack squads (iOS, Web, Backend), driving the development, architecture, and maintenance of user-facing, high-visibility features and scalable APIs across multiple stacks.\item \textbf{Enterprise AI Integration  and  Optimization:} Drives the integration and experimentation of enterprise AI tooling across team workflows, actively utilizing AI within daily operations to realize new efficiencies, measure quality gains, and drive continuous improvement.\item \textbf{Cloud-Native  and  Scalable Systems:} Proven history of building highly scalable distributed systems and processes in cloud environments, including Dockerized setups, leveraging AWS services (ECS, Lambda, RDS, Redshift, Glue), and designing robust RESTful, JSON, HTTP APIs.\item \textbf{Data-Driven Growth  and  Experimentation:} Cultivates a culture of experimentation, leveraging A/B testing and data analytics to validate hypotheses and optimize creator onboarding and reporting funnels, identifying appropriate metrics for team performance.
\end{itemize}
